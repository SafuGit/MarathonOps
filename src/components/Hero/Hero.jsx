  ...
  return (
    <div className="hero bg-base-200 min-h-screen">
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        />
        <img src="/assets/marathonRunner2Crop.png" alt="" className='' />
        <div className='w-full'>
          <h1 className="text-8xl font-bold text-green-950 w-full inline">THE ULTIMATE <br /> <span className='italic'> MARATHON APP </span></h1>
          <p className="pb-6 pt-2 w-1/2 text-gray-500 font-extralight">
